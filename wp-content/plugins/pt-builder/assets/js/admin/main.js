jQuery(document).ready(function($){
	...
	$pt_button.attr( 'title', 'Fire up power themes page builder' );
	$pt_button.html( '<img src="'+pt_data.url+'/assets/images/admin/logo_icon_s.svg"> PT Builder' );
	...
	function pt_start_builder(){
		$('#postdivrich').hide();
		$pt_button.html( '<img src="'+pt_data.url+'/assets/images/admin/logo_icon_s.svg"> Classic Editor' );
