	...
	public function generate_html(){
			...
			foreach( $image_ids as $image_id ){
				...
				if( !empty( $image_data ) ){
					$images .= '<div class="pt-image-wrapper">
									<img src="'.$image_data[0].'" class="pt-option-thumb" data-image_id="'.$image_id.'"/>
									<a href="javascript:;" class="remove_images" data-image_id="'.$image_id.'"><span class="fa fa-times"></span></a>
								</div>';
				}
			}
		}
		...
		$this->field_html = '
			<div class="pt-option-container">
				...
				<input id="'.$id.'" class="pt-option pt-images" value="'.$value.'" type="hidden" />
