...
class PT_Accordion extends PT_Shortcode{
	...
	public function shortcode_frontend( $atts, $content ){
		...
		$html = '';
		if( !empty( $titles ) ){
			$html = '<div class="panel-group '.$extra_class.'" id="'.$random_string.'">';
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#'.$random_string.'" href="#'.$random_string.'_'.$i.'">
									'.$title.'
								</a>
							</h4>
						</div>
						<div id="'.$random_string.'_'.$i.'" class="panel-collapse collapse '.( $i == 0 ? 'in' : '' ).'">
