...
class PT_Row extends PT_Shortcode{
	...
	public function shortcode_admin( $atts, $content ){
		...
		return '<div class="pt-row pt-element-root" data-shortcode_id="'.$atts['shortcode_id'].'" data-shortcode_element="PT_Row">
					<div class="pt-actions clearfix">						
						<a href="javascript:;" class="pt-row-drag" title="'.__( 'Drag Row', 'pt-builder' ).'"><span class="fa fa-arrows"></span></a>												
						<a href="javascript:;" class="pt-edit" title="'.__( 'Edit Element', 'pt-builder' ).'"><span class="fa fa-pencil"></span></a>
						<div class="pt-layout-box">
					...
					<div class="pt-row-content '.$atts['shortcode_id'].' clearfix pt-collapsible">
