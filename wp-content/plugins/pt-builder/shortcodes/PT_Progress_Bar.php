...
class PT_Progress_Bar extends PT_Shortcode{
	...
	public function shortcode_frontend( $atts, $content ){
		...
		return '<div class="progress '.$extra_class.'">
                    <div class="progress-bar '.$style.'" role="progressbar" aria-valuenow="'.$value.'" aria-valuemin="0" aria-valuemax="100" style="width: '.$value.'%; background-color: '.$color.';">
                        '.$label.'
                    </div>
                </div>';
	}
